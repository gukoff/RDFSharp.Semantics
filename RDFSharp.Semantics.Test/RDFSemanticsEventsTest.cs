...
{
    [TestClass]
    public class RDFSemanticsEventsTest
    {
        #region Test
        [TestMethod]
        ...
        {
            string infoMsg = null;
            RDFSemanticsEvents.OnSemanticsInfo += (string msg) => { infoMsg = msg; };
            RDFSemanticsEvents.RaiseSemanticsInfo("Hello Info");
        ...
        public void ShouldSubscribeWarningEvents()
        {
            ...
            RDFSemanticsEvents.RaiseSemanticsWarning("Hello Warning");
