...
namespace RDFSharp.Semantics.Test
{
    ...
    public class OWLOntologyClassModelTest
    {
        ...
        public void ShouldThrowExceptionOnDeclaringClassBecauseNull()
            => Assert.ThrowsException<OWLSemanticsException>(() => new OWLOntologyClassModel().DeclareClass(null));
        ...
        public void ShouldThrowExceptionOnDeclaringSomeValuesFromRestrictionBecauseNullClass()
            => Assert.ThrowsException<OWLSemanticsException>(() => new OWLOntologyClassModel().DeclareSomeValuesFromRestriction(new RDFResource("ex:svClass"), new RDFResource("ex:onProp"), null));
        ...
        public void ShouldThrowExceptionOnDeclaringHasValueRestrictionBecauseNull()
            => Assert.ThrowsException<OWLSemanticsException>(() => new OWLOntologyClassModel().DeclareHasValueRestriction(new RDFResource("ex:hvRestr"), new RDFResource("ex:onProp"), null as RDFResource));
        ...
        public void ShouldThrowExceptionOnDeclaringHasValueLiteralRestrictionBecauseNull()
            => Assert.ThrowsException<OWLSemanticsException>(() => new OWLOntologyClassModel().DeclareHasValueRestriction(new RDFResource("ex:hvRestr"), new RDFResource("ex:onProp"), null as RDFLiteral));
        ...
        public void ShouldThrowExceptionOnDeclaringMinMaxCardinalityRestrictionBecauseInvalidMax()
            => Assert.ThrowsException<OWLSemanticsException>(() => new OWLOntologyClassModel().DeclareMinMaxCardinalityRestriction(new RDFResource("ex:cRestr"), new RDFResource("ex:onProp"), 2, 1));
        ...
        public void ShouldThrowExceptionOnDeclaringMaxQualifiedCardinalityRestrictionBecauseNullClass()
            => Assert.ThrowsException<OWLSemanticsException>(() => new OWLOntologyClassModel().DeclareMaxQualifiedCardinalityRestriction(new RDFResource("ex:cRestr"), new RDFResource("ex:onProp"), 1, null));
        ...
        public void ShouldThrowExceptionOnDeclaringMinMaxQualifiedCardinalityRestrictionBecauseInvalidMax()
            => Assert.ThrowsException<OWLSemanticsException>(() => new OWLOntologyClassModel().DeclareMinMaxQualifiedCardinalityRestriction(new RDFResource("ex:cRestr"), new RDFResource("ex:onProp"), 2, 1, new RDFResource("ex:onClass")));
        ...
        public void ShouldThrowExceptionOnDeclaringEnumerateClassBecauseNullClass()
            => Assert.ThrowsException<OWLSemanticsException>(() => new OWLOntologyClassModel().DeclareEnumerateClass(null, new List<RDFResource>() { new RDFResource("ex:indiv1") }));

        [TestMethod]
        public void ShouldThrowExceptionOnDeclaringEnumerateClassBecauseNullIndividuals()
            => Assert.ThrowsException<OWLSemanticsException>(() => new OWLOntologyClassModel().DeclareEnumerateClass(new RDFResource("ex:enumClass"), null));

        [TestMethod]
        public void ShouldThrowExceptionOnDeclaringEnumerateClassBecauseEmptyIndividuals()
            => Assert.ThrowsException<OWLSemanticsException>(() => new OWLOntologyClassModel().DeclareEnumerateClass(new RDFResource("ex:enumClass"), new List<RDFResource>()));
        ...
        public void ShouldThrowExceptionOnDeclaringUnionClassBecauseNullClasses()
            => Assert.ThrowsException<OWLSemanticsException>(() => new OWLOntologyClassModel().DeclareUnionClass(new RDFResource("ex:unionClass"), null));

        [TestMethod]
        public void ShouldThrowExceptionOnDeclaringUnionClassBecauseEmptyClasses()
            => Assert.ThrowsException<OWLSemanticsException>(() => new OWLOntologyClassModel().DeclareUnionClass(new RDFResource("ex:unionClass"), new List<RDFResource>()));

        [TestMethod]
        public void ShouldThrowExceptionOnDeclaringUnionClassBecauseSelfClass()
            => Assert.ThrowsException<OWLSemanticsException>(() => new OWLOntologyClassModel().DeclareUnionClass(new RDFResource("ex:class1"), new List<RDFResource>() { new RDFResource("ex:class1"), new RDFResource("ex:class2") }));
        ...
        public void ShouldThrowExceptionOnDeclaringIntersectionClassBecauseNullClass()
            => Assert.ThrowsException<OWLSemanticsException>(() => new OWLOntologyClassModel().DeclareIntersectionClass(null, new List<RDFResource>() { new RDFResource("ex:class1") }));

        [TestMethod]
        public void ShouldThrowExceptionOnDeclaringIntersectionClassBecauseNullClasses()
            => Assert.ThrowsException<OWLSemanticsException>(() => new OWLOntologyClassModel().DeclareIntersectionClass(new RDFResource("ex:intersectionClass"), null));

        [TestMethod]
        public void ShouldThrowExceptionOnDeclaringIntersectionClassBecauseEmptyClasses()
            => Assert.ThrowsException<OWLSemanticsException>(() => new OWLOntologyClassModel().DeclareIntersectionClass(new RDFResource("ex:intersectionClass"), new List<RDFResource>()));

        [TestMethod]
        public void ShouldThrowExceptionOnDeclaringIntersectionClassBecauseSelfClass()
            => Assert.ThrowsException<OWLSemanticsException>(() => new OWLOntologyClassModel().DeclareIntersectionClass(new RDFResource("ex:class1"), new List<RDFResource>() { new RDFResource("ex:class1"), new RDFResource("ex:class2") }));
        ...
        public void ShouldThrowExceptionOnDeclaringComplementClassBecauseNullComplementClass()
            => Assert.ThrowsException<OWLSemanticsException>(() => new OWLOntologyClassModel().DeclareComplementClass(new RDFResource("ex:complementClass"), null));

        [TestMethod]
        public void ShouldThrowExceptionOnDeclaringComplementClassBecauseSelfClass()
            => Assert.ThrowsException<OWLSemanticsException>(() => new OWLOntologyClassModel().DeclareComplementClass(new RDFResource("ex:complementClass"), new RDFResource("ex:complementClass")));
        ...
        public void ShouldThrowExceptionOnDeclaringDisjointUnionClassBecauseNullClass()
            => Assert.ThrowsException<OWLSemanticsException>(() => new OWLOntologyClassModel().DeclareDisjointUnionClass(null, new List<RDFResource>() { new RDFResource("ex:class1") }));

        [TestMethod]
        public void ShouldThrowExceptionOnDeclaringDisjointUnionClassBecauseNullClasses()
            => Assert.ThrowsException<OWLSemanticsException>(() => new OWLOntologyClassModel().DeclareDisjointUnionClass(new RDFResource("ex:disjointUnionClass"), null));

        [TestMethod]
        public void ShouldThrowExceptionOnDeclaringDisjointUnionClassBecauseEmptyClasses()
            => Assert.ThrowsException<OWLSemanticsException>(() => new OWLOntologyClassModel().DeclareDisjointUnionClass(new RDFResource("ex:disjointUnionClass"), new List<RDFResource>()));
        ...
        public void ShouldThrowExceptionOnDeclaringAllDisjointClassesBecauseNullClass()
            => Assert.ThrowsException<OWLSemanticsException>(() => new OWLOntologyClassModel().DeclareAllDisjointClasses(null, new List<RDFResource>() { new RDFResource("ex:class1") }));

        [TestMethod]
        public void ShouldThrowExceptionOnDeclaringAllDisjointClassesBecauseNullClasses()
            => Assert.ThrowsException<OWLSemanticsException>(() => new OWLOntologyClassModel().DeclareAllDisjointClasses(new RDFResource("ex:allDisjointClasses"), null));

        [TestMethod]
        public void ShouldThrowExceptionOnDeclaringAllDisjointClassesBecauseEmptyClasses()
            => Assert.ThrowsException<OWLSemanticsException>(() => new OWLOntologyClassModel().DeclareAllDisjointClasses(new RDFResource("ex:allDisjointClasses"), new List<RDFResource>()));
        ...
        public void ShouldThrowExceptionOnAnnotatingResourceClassBecauseNullSubject()
            => Assert.ThrowsException<OWLSemanticsException>(() => new OWLOntologyClassModel()
        ...
        public void ShouldThrowExceptionOnDeclaringHasKeyBecauseNullClass()
            => Assert.ThrowsException<OWLSemanticsException>(() => new OWLOntologyClassModel().DeclareHasKey(null, new List<RDFResource>() { new RDFResource("ex:dtProp") }));

        [TestMethod]
        public void ShouldThrowExceptionOnDeclaringHasKeyBecauseNullClasses()
            => Assert.ThrowsException<OWLSemanticsException>(() => new OWLOntologyClassModel().DeclareHasKey(new RDFResource("ex:classA"), null));

        [TestMethod]
        public void ShouldThrowExceptionOnDeclaringHasKeyBecauseEmptyClasses()
            => Assert.ThrowsException<OWLSemanticsException>(() => new OWLOntologyClassModel().DeclareHasKey(new RDFResource("ex:classA"), new List<RDFResource>()));
