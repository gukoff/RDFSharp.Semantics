...
{
    [TestClass]
    public class RDFOntologyClassModelLensTest
    {
        #region Initialize
        private RDFOntologyClassModelLens ModelLens { get; set; }

        [TestInitialize]
        public void Initialize()
        {
            ModelLens = new RDFOntologyClassModelLens(new RDFResource("ex:class1"), new RDFOntology("ex:ont"));
