...
{
    [TestClass]
    public class RDFOntologyPropertyModelLensTest
    {
        #region Initialize
        private RDFOntologyPropertyModelLens ModelLens { get; set; }

        [TestInitialize]
        public void Initialize()
        {
            ModelLens = new RDFOntologyPropertyModelLens(new RDFResource("ex:objprop1"), new RDFOntology("ex:ont"));
