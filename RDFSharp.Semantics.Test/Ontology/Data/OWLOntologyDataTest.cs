...
namespace RDFSharp.Semantics.Test
{
    ...
    public class OWLOntologyDataTest
    {
        ...
        public void ShouldThrowExceptionOnDeclaringIndividualBecauseNull()
            => Assert.ThrowsException<OWLSemanticsException>(() => new OWLOntologyData().DeclareIndividual(null));
        ...
        public void ShouldThrowExceptionOnAnnotatingResourceIndividualBecauseNullSubject()
            => Assert.ThrowsException<OWLSemanticsException>(() => new OWLOntologyData()
