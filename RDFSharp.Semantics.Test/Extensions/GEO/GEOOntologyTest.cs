...
namespace RDFSharp.Semantics.Extensions.GEO.Test
{
    ...
    public class GEOOntologyTest
    {
        ...
        public void ShouldDeclarePoint()
        {
            ...
            Assert.IsTrue(geoOnt.Ontology.Data.CheckIsIndividualOf(geoOnt.Ontology.Model, new RDFResource("ex:Milan"), new RDFResource("http://www.opengis.net/ont/sf#Point")));
