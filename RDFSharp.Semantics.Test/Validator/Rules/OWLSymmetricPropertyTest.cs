...
{
    [TestClass]
    public class OWLSymmetricPropertyTest
    {
        #region Tests
        [TestMethod]
        ...
        public void ShouldValidateSymmetricPropertyViaValidator()
        {
            ...
            OWLValidator validator = new OWLValidator().AddStandardRule(OWLSemanticsEnums.OWLValidatorStandardRules.SymmetricProperty);
