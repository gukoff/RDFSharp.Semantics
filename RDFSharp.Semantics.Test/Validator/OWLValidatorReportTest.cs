...
namespace RDFSharp.Semantics.Validator.Test
{
    ...
    public class OWLValidatorReportTest
    {
        ...
        public void ShouldMergeValidatorEvidences()
        {
            ...
            report1.AddEvidence(new OWLValidatorEvidence(OWLSemanticsEnums.OWLValidatorEvidenceCategory.Error, "rulename", "message", "suggestion"));
        ...
        {
            OWLValidatorReport report = new OWLValidatorReport();
            report.AddEvidence(new OWLValidatorEvidence(OWLSemanticsEnums.OWLValidatorEvidenceCategory.Warning, "rulename", "message", "suggestion"));
            report.AddEvidence(new OWLValidatorEvidence(OWLSemanticsEnums.OWLValidatorEvidenceCategory.Error, "rulename", "message", "suggestion"));
