...
namespace RDFSharp.Semantics.Reasoner.Test
{
    ...
    public class OWLReasonerEvidenceTest
    {
        ...
        public void ShouldCreateReasonerEvidence()
        {
            ...
            Assert.IsTrue(evidence.EvidenceCategory == OWLSemanticsEnums.OWLReasonerEvidenceCategory.ClassModel);
        ...
        public void ShouldThrowExceptionOnCreatingReasonerEvidenceBecauseNullOrEmptyRule()
            => Assert.ThrowsException<OWLSemanticsException>(() => new OWLReasonerEvidence(OWLSemanticsEnums.OWLReasonerEvidenceCategory.PropertyModel, 
        ...
        public void ShouldThrowExceptionOnCreatingReasonerEvidenceBecauseNullContent()
            => Assert.ThrowsException<OWLSemanticsException>(() => new OWLReasonerEvidence(OWLSemanticsEnums.OWLReasonerEvidenceCategory.PropertyModel, "testRule", null));
        #endregion
    }
}