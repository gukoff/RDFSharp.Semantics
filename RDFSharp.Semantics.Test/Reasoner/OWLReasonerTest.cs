...
namespace RDFSharp.Semantics.Reasoner.Test
{
    ...
    public class OWLReasonerTest
    {
        ...
        public void ShouldAddStandarReasonerRule()
        {
            ...
            reasoner.AddStandardRule(OWLSemanticsEnums.OWLReasonerStandardRules.SubClassTransitivity); //Will be discarded, since duplicate standard rules are not allowed
