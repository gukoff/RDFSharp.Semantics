...
namespace RDFSharp.Semantics.Reasoner.Test
{
    ...
    public class OWLReasonerRulePowBuiltInTest
    {
        ...
        public void ShouldThrowExceptionOnCreatingPowBuiltInBecauseNullLeftArgument()
            => Assert.ThrowsException<OWLSemanticsException>(() => new OWLReasonerRulePowBuiltIn(null, new RDFVariable("?R"), 2));

        [TestMethod]
        public void ShouldThrowExceptionOnCreatingPowBuiltInBecauseNullRightArgument()
            => Assert.ThrowsException<OWLSemanticsException>(() => new OWLReasonerRulePowBuiltIn(new RDFVariable("?L"), null, 2));
