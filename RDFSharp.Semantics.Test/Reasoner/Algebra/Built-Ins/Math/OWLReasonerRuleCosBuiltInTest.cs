...
namespace RDFSharp.Semantics.Reasoner.Test
{
    ...
    public class OWLReasonerRuleCosBuiltInTest
    {
        ...
        public void ShouldThrowExceptionOnCreatingCosBuiltInBecauseNullLeftArgument()
            => Assert.ThrowsException<OWLSemanticsException>(() => new OWLReasonerRuleCosBuiltIn(null, new RDFVariable("?R")));

        [TestMethod]
        public void ShouldThrowExceptionOnCreatingCosBuiltInBecauseNullRightArgument()
            => Assert.ThrowsException<OWLSemanticsException>(() => new OWLReasonerRuleCosBuiltIn(new RDFVariable("?L"), null));
