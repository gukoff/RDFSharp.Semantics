...
namespace RDFSharp.Semantics.Reasoner.Test
{
    ...
    public class OWLReasonerRuleDivideBuiltInTest
    {
        ...
        public void ShouldThrowExceptionOnCreatingDivideBuiltInBecauseNullLeftArgument()
            => Assert.ThrowsException<OWLSemanticsException>(() => new OWLReasonerRuleDivideBuiltIn(null, new RDFVariable("?R"), 2));

        [TestMethod]
        public void ShouldThrowExceptionOnCreatingDivideBuiltInBecauseNullRightArgument()
            => Assert.ThrowsException<OWLSemanticsException>(() => new OWLReasonerRuleDivideBuiltIn(new RDFVariable("?L"), null, 2));

        [TestMethod]
        public void ShouldThrowExceptionOnCreatingDivideBuiltInBecauseZeroDivide()
           => Assert.ThrowsException<OWLSemanticsException>(() => new OWLReasonerRuleDivideBuiltIn(new RDFVariable("?L"), new RDFVariable("?R"), 0));
