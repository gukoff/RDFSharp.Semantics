...
namespace RDFSharp.Semantics.Reasoner.Test
{
    ...
    public class OWLReasonerRuleNotEqualBuiltInTest
    {
        ...
        public void ShouldThrowExceptionOnCreatingNotEqualBuiltInBecauseNullLeftArgument()
            => Assert.ThrowsException<OWLSemanticsException>(() => new OWLReasonerRuleNotEqualBuiltIn(null, new RDFVariable("?R")));

        [TestMethod]
        public void ShouldThrowExceptionOnCreatingNotEqualBuiltInBecauseNullRightArgumentVariable()
            => Assert.ThrowsException<OWLSemanticsException>(() => new OWLReasonerRuleNotEqualBuiltIn(new RDFVariable("?L"), null as RDFVariable));

        [TestMethod]
        public void ShouldThrowExceptionOnCreatingNotEqualBuiltInBecauseNullRightArgumentResource()
            => Assert.ThrowsException<OWLSemanticsException>(() => new OWLReasonerRuleNotEqualBuiltIn(new RDFVariable("?L"), null as RDFResource));

        [TestMethod]
        public void ShouldThrowExceptionOnCreatingNotEqualBuiltInBecauseNullRightArgumentLiteral()
            => Assert.ThrowsException<OWLSemanticsException>(() => new OWLReasonerRuleNotEqualBuiltIn(new RDFVariable("?L"), null as RDFLiteral));
