...
namespace RDFSharp.Semantics.Reasoner.Test
{
    ...
    public class OWLReasonerRuleLessThanOrEqualBuiltInTest
    {
        ...
        public void ShouldThrowExceptionOnCreatingLessThanOrEqualBuiltInBecauseNullLeftArgument()
            => Assert.ThrowsException<OWLSemanticsException>(() => new OWLReasonerRuleLessThanOrEqualBuiltIn(null, new RDFVariable("?R")));

        [TestMethod]
        public void ShouldThrowExceptionOnCreatingLessThanOrEqualBuiltInBecauseNullRightArgumentVariable()
            => Assert.ThrowsException<OWLSemanticsException>(() => new OWLReasonerRuleLessThanOrEqualBuiltIn(new RDFVariable("?L"), null as RDFVariable));

        [TestMethod]
        public void ShouldThrowExceptionOnCreatingLessThanOrEqualBuiltInBecauseNullRightArgumentResource()
            => Assert.ThrowsException<OWLSemanticsException>(() => new OWLReasonerRuleLessThanOrEqualBuiltIn(new RDFVariable("?L"), null as RDFResource));

        [TestMethod]
        public void ShouldThrowExceptionOnCreatingLessThanOrEqualBuiltInBecauseNullRightArgumentLiteral()
            => Assert.ThrowsException<OWLSemanticsException>(() => new OWLReasonerRuleLessThanOrEqualBuiltIn(new RDFVariable("?L"), null as RDFLiteral));
