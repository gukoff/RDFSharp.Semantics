...
namespace RDFSharp.Semantics.Reasoner.Test
{
    ...
    public class OWLReasonerRuleEndsWithBuiltInTest
    {
        ...
        public void ShouldThrowExceptionOnCreatingEndsWithBuiltInBecauseNullLeftArgument()
            => Assert.ThrowsException<OWLSemanticsException>(() => new OWLReasonerRuleEndsWithBuiltIn(null, "val"));

        [TestMethod]
        public void ShouldThrowExceptionOnCreatingEndsWithBuiltInBecauseNullRightArgument()
            => Assert.ThrowsException<OWLSemanticsException>(() => new OWLReasonerRuleEndsWithBuiltIn(new RDFVariable("?L"), null));
