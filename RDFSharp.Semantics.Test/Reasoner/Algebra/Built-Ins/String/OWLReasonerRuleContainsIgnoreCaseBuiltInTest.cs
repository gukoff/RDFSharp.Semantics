...
namespace RDFSharp.Semantics.Reasoner.Test
{
    ...
    public class OWLReasonerRuleContainsIgnoreCaseBuiltInTest
    {
        ...
        public void ShouldThrowExceptionOnCreatingContainsIgnoreCaseBuiltInBecauseNullLeftArgument()
            => Assert.ThrowsException<OWLSemanticsException>(() => new OWLReasonerRuleContainsIgnoreCaseBuiltIn(null, "val"));

        [TestMethod]
        public void ShouldThrowExceptionOnCreatingContainsIgnoreCaseBuiltInBecauseNullRightArgument()
            => Assert.ThrowsException<OWLSemanticsException>(() => new OWLReasonerRuleContainsIgnoreCaseBuiltIn(new RDFVariable("?L"), null));
