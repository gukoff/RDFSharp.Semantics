...
namespace RDFSharp.Semantics.Reasoner.Test
{
    ...
    public class OWLReasonerRuleMatchesBuiltInTest
    {
        ...
        public void ShouldThrowExceptionOnCreatingMatchesBuiltInBecauseNullLeftArgument()
            => Assert.ThrowsException<OWLSemanticsException>(() => new OWLReasonerRuleMatchesBuiltIn(null, new Regex("val")));

        [TestMethod]
        public void ShouldThrowExceptionOnCreatingMatchesBuiltInBecauseNullRightArgument()
            => Assert.ThrowsException<OWLSemanticsException>(() => new OWLReasonerRuleMatchesBuiltIn(new RDFVariable("?L"), null));
