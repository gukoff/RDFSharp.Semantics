...
namespace RDFSharp.Semantics.Reasoner.Test
{
    ...
    public class OWLReasonerRuleTest
    {
        ...
        public void ShouldThrowExceptionOnCreatingReasonerRuleBecauseNullOrEmptyRuleName()
            => Assert.ThrowsException<OWLSemanticsException>(() => new OWLReasonerRule(null, "this is test rule",
        ...
        public void ShouldThrowExceptionOnCreatingReasonerRuleBecauseNullAntecedent()
           => Assert.ThrowsException<OWLSemanticsException>(() => new OWLReasonerRule("testRule", "this is test rule",
               null, new OWLReasonerRuleConsequent()));

        [TestMethod]
        public void ShouldThrowExceptionOnCreatingReasonerRuleBecauseNullConsequent()
           => Assert.ThrowsException<OWLSemanticsException>(() => new OWLReasonerRule("testRule", "description",
