...
namespace RDFSharp.Semantics.Reasoner.Test
{
    ...
    public class OWLReasonerRuleSameAsAtomTest
    {
        ...
        public void ShouldThrowExceptionOnCreatingSameAsAtomBecauseNullLeftArgument()
            => Assert.ThrowsException<OWLSemanticsException>(() => new OWLReasonerRuleSameAsAtom(null, new RDFVariable("?R")));

        [TestMethod]
        public void ShouldThrowExceptionOnCreatingSameAsAtomBecauseNullRightArgumentVariable()
            => Assert.ThrowsException<OWLSemanticsException>(() => new OWLReasonerRuleSameAsAtom(new RDFVariable("?L"), null as RDFVariable));

        [TestMethod]
        public void ShouldThrowExceptionOnCreatingSameAsAtomBecauseNullRightArgumentResource()
            => Assert.ThrowsException<OWLSemanticsException>(() => new OWLReasonerRuleSameAsAtom(new RDFVariable("?L"), null as RDFResource));
