...
namespace RDFSharp.Semantics.Reasoner.Test
{
    ...
    public class OWLReasonerRuleObjectPropertyAtomTest
    {
        ...
        public void ShouldThrowExceptionOnCreatingObjectPropertyAtomBecauseNullPredicate()
            => Assert.ThrowsException<OWLSemanticsException>(() => new OWLReasonerRuleObjectPropertyAtom(null, new RDFVariable("?L"), new RDFVariable("?R")));

        [TestMethod]
        public void ShouldThrowExceptionOnCreatingObjectPropertyAtomBecauseNullLeftArgument()
            => Assert.ThrowsException<OWLSemanticsException>(() => new OWLReasonerRuleObjectPropertyAtom(new RDFResource("ex:objprop"), null, new RDFVariable("?R")));

        [TestMethod]
        public void ShouldThrowExceptionOnCreatingObjectPropertyAtomBecauseNullRightArgumentVariable()
            => Assert.ThrowsException<OWLSemanticsException>(() => new OWLReasonerRuleObjectPropertyAtom(new RDFResource("ex:objprop"), new RDFVariable("?L"), null as RDFVariable));

        [TestMethod]
        public void ShouldThrowExceptionOnCreatingObjectPropertyAtomBecauseNullRightArgumentResource()
            => Assert.ThrowsException<OWLSemanticsException>(() => new OWLReasonerRuleObjectPropertyAtom(new RDFResource("ex:objprop"), new RDFVariable("?L"), null as RDFResource));
