...
namespace RDFSharp.Semantics.Reasoner.Test
{
    ...
    public class OWLReasonerRuleDataPropertyAtomTest
    {
        ...
        public void ShouldThrowExceptionOnCreatingDataPropertyAtomBecauseNullPredicate()
            => Assert.ThrowsException<OWLSemanticsException>(() => new OWLReasonerRuleDataPropertyAtom(null, new RDFVariable("?L"), new RDFVariable("?R")));

        [TestMethod]
        public void ShouldThrowExceptionOnCreatingDataPropertyAtomBecauseNullLeftArgument()
            => Assert.ThrowsException<OWLSemanticsException>(() => new OWLReasonerRuleDataPropertyAtom(new RDFResource("ex:dtprop"), null, new RDFVariable("?R")));

        [TestMethod]
        public void ShouldThrowExceptionOnCreatingDataPropertyAtomBecauseNullRightArgumentVariable()
            => Assert.ThrowsException<OWLSemanticsException>(() => new OWLReasonerRuleDataPropertyAtom(new RDFResource("ex:dtprop"), new RDFVariable("?L"), null as RDFVariable));

        [TestMethod]
        public void ShouldThrowExceptionOnCreatingDataPropertyAtomBecauseNullRightArgumentLiteral()
            => Assert.ThrowsException<OWLSemanticsException>(() => new OWLReasonerRuleDataPropertyAtom(new RDFResource("ex:dtprop"), new RDFVariable("?L"), null as RDFLiteral));
