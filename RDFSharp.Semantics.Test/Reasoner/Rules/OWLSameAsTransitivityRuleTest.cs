...
namespace RDFSharp.Semantics.Reasoner.Test
{
    ...
    public class OWLSameAsTransitivityRuleTest
    {
        ...
        public void ShouldExecuteSameAsTransitivity()
        {
            ...
            OWLReasonerReport reasonerReport = OWLSameAsTransitivityRule.ExecuteRule(ontology, OWLOntologyLoaderOptions.DefaultOptions);
        ...
        public void ShouldExecuteSameAsTransitivityViaReasoner()
        {
            ...
            OWLReasoner reasoner = new OWLReasoner().AddStandardRule(OWLSemanticsEnums.OWLReasonerStandardRules.SameAsTransitivity);
