...
namespace RDFSharp.Semantics.Reasoner.Test
{
    ...
    public class OWLRangeEntailmentRuleTest
    {
        ...
        public void ShouldExecuteRangeEntailmentOnObjectProperties()
        {
            ...
            OWLReasonerReport reasonerReport = OWLRangeEntailmentRule.ExecuteRule(ontology, OWLOntologyLoaderOptions.DefaultOptions);
        ...
        public void ShouldExecuteRangeEntailmentOnObjectPropertiesViaReasoner()
        {
            ...
            OWLReasoner reasoner = new OWLReasoner().AddStandardRule(OWLSemanticsEnums.OWLReasonerStandardRules.RangeEntailment);
