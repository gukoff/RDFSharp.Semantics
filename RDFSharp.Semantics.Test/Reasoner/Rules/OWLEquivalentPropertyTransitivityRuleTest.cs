...
namespace RDFSharp.Semantics.Reasoner.Test
{
    ...
    public class OWLEquivalentPropertyTransitivityRuleTest
    {
        ...
        public void ShouldExecuteEquivalentObjectPropertyTransitivity()
        {
            ...
            OWLReasonerReport reasonerReport = OWLEquivalentPropertyTransitivityRule.ExecuteRule(ontology, OWLOntologyLoaderOptions.DefaultOptions);
        ...
        public void ShouldExecuteEquivalentObjectPropertyTransitivityViaReasoner()
        {
            ...
            OWLReasoner reasoner = new OWLReasoner().AddStandardRule(OWLSemanticsEnums.OWLReasonerStandardRules.EquivalentPropertyTransitivity);
