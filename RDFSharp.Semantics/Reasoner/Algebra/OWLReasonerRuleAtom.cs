...
namespace RDFSharp.Semantics
{
    ...
    public abstract class OWLReasonerRuleAtom
    {
        ...
        {
            if (predicate == null)
                throw new OWLSemanticsException("Cannot create atom because given \"predicate\" parameter is null");
            if (leftArgument == null)
                throw new OWLSemanticsException("Cannot create atom because given \"leftArgument\" parameter is null");
