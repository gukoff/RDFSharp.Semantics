                                                                                                   ...
                                                                                                   || ontology.Model.PropertyModel.CheckHasDatatypeProperty((RDFResource)t.Predicate)))
                    {
                        foreach (RDFResource sameIndividual in sameIndividuals)
                        {
                            ...
                            OWLReasonerEvidence evidence = currentIndividualSubjectTriple.TripleFlavor == RDFModelEnums.RDFTripleFlavors.SPO
                                ? new OWLReasonerEvidence(OWLSemanticsEnums.OWLReasonerEvidenceCategory.Data, nameof(OWLSameAsEntailmentRule), new RDFTriple(sameIndividual, (RDFResource)currentIndividualSubjectTriple.Predicate, (RDFResource)currentIndividualSubjectTriple.Object))
                                : new OWLReasonerEvidence(OWLSemanticsEnums.OWLReasonerEvidenceCategory.Data, nameof(OWLSameAsEntailmentRule), new RDFTriple(sameIndividual, (RDFResource)currentIndividualSubjectTriple.Predicate, (RDFLiteral)currentIndividualSubjectTriple.Object));
