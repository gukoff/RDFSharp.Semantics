...
{
    /// <summary>
    /// OWL-DL reasoner rule targeting data knowledge (A-BOX) to navigate owl:sameAs relations
    /// </summary>
        ...
        internal static OWLReasonerReport ExecuteRule(OWLOntology ontology)
        {
            ...
            void InferSameIndividuals(RDFResource currentIndividual, OWLReasonerReport report)
            {
                ...
                foreach (RDFResource sameIndividual in sameIndividuals)
                {
                    ...
                    OWLReasonerEvidence evidenceA = new OWLReasonerEvidence(OWLSemanticsEnums.OWLReasonerEvidenceCategory.Data,
                        nameof(OWLSameAsTransitivityRule), new RDFTriple(currentIndividual, RDFVocabulary.OWL.SAME_AS, sameIndividual));
                    OWLReasonerEvidence evidenceB = new OWLReasonerEvidence(OWLSemanticsEnums.OWLReasonerEvidenceCategory.Data,
