...
{
    /// <summary>
    /// RDFSemanticsUtilities is a collector of reusable utility methods for ontology management
    /// </summary>
    internal static class RDFSemanticsUtilities
    {
        ...
        /// </summary>
        internal static readonly HashSet<long> StandardOntologyAnnotations = new HashSet<long>(StandardResourceAnnotations)
        {
            //OWL
            { RDFVocabulary.OWL.PRIOR_VERSION.PatternMemberID },
            { RDFVocabulary.OWL.BACKWARD_COMPATIBLE_WITH.PatternMemberID },
        ...
        /// </summary>
        internal static readonly HashSet<long> StandardResourceAnnotations = new HashSet<long>()
        {
            //RDFS
            { RDFVocabulary.RDFS.COMMENT.PatternMemberID },
            { RDFVocabulary.RDFS.LABEL.PatternMemberID },
