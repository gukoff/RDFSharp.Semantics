    ...
    public class OWLOntologyDataLens
    {
        ...
        public OWLOntologyDataLens(RDFResource owlIndividual, OWLOntology ontology)
        {
            if (owlIndividual == null)
                throw new OWLSemanticsException("Cannot create data lens because given \"owlIndividual\" parameter is null");
            if (ontology == null)
                throw new OWLSemanticsException("Cannot create data lens because given \"ontology\" parameter is null");
