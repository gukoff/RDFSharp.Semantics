    ...
    public class OWLOntologyPropertyModel : IEnumerable<RDFResource>
    {
        ...
        public OWLOntologyPropertyModel AnnotateProperty(RDFResource owlProperty, RDFResource annotationProperty, RDFResource annotationValue)
        {
            ...
            if (annotationProperty == null)
                throw new OWLSemanticsException("Cannot annotate owl property because given \"annotationProperty\" parameter is null");
        ...
        public OWLOntologyPropertyModel DeclareSubProperties(RDFResource childProperty, RDFResource motherProperty)
        {
            ...
            bool OWLDLIntegrityChecks()
                => !childProperty.CheckReservedProperty()
                      && !motherProperty.CheckReservedProperty()
                        && (OWLSemanticsOptions.DisableOntologyProtection || this.CheckSubPropertyCompatibility(childProperty, motherProperty));
            #endregion
            ...
            {
                //Handle automatic property declaration, if configured
                if (OWLSemanticsOptions.EnableAutomaticPropertyDeclaration)
                {
        ...
        public OWLOntologyPropertyModel DeclareEquivalentProperties(RDFResource leftProperty, RDFResource rightProperty)
        {
            ...
            bool OWLDLIntegrityChecks()
                => !leftProperty.CheckReservedProperty()
                      && !rightProperty.CheckReservedProperty()
                        && (OWLSemanticsOptions.DisableOntologyProtection || this.CheckEquivalentPropertyCompatibility(leftProperty, rightProperty));
            #endregion
            ...
            if (OWLDLIntegrityChecks())
            {
                ...
                OWLSemanticsEvents.RaiseSemanticsWarning(string.Format("EquivalentProperty relation between property '{0}' and property '{1}' cannot be declared to the model because it would violate OWL-DL integrity", leftProperty, rightProperty));
        ...
        public OWLOntologyPropertyModel DeclareDisjointProperties(RDFResource leftProperty, RDFResource rightProperty)
        {
            ...
            bool OWLDLIntegrityChecks()
                => !leftProperty.CheckReservedProperty()
                      && !rightProperty.CheckReservedProperty()
                        && (OWLSemanticsOptions.DisableOntologyProtection || this.CheckDisjointPropertyCompatibility(leftProperty, rightProperty));
            #endregion
            ...
            if (OWLDLIntegrityChecks())
            {
                ...
                OWLSemanticsEvents.RaiseSemanticsWarning(string.Format("PropertyDisjointWith relation between property '{0}' and property '{1}' cannot be declared to the model because it would violate OWL-DL integrity", leftProperty, rightProperty));
        ...
        public OWLOntologyPropertyModel DeclareAllDisjointProperties(RDFResource owlClass, List<RDFResource> disjointProperties)
        {
            ...
            //Handle automatic property declaration, if configured
            if (OWLSemanticsOptions.EnableAutomaticPropertyDeclaration)
                disjointProperties.ForEach(p => DeclareObjectProperty(p));
        ...
        public OWLOntologyPropertyModel DeclareInverseProperties(RDFResource leftProperty, RDFResource rightProperty)
        {
            ...
            bool OWLDLIntegrityChecks()
                => !leftProperty.CheckReservedProperty()
                      && !rightProperty.CheckReservedProperty()
                        && (OWLSemanticsOptions.DisableOntologyProtection || this.CheckInversePropertyCompatibility(leftProperty, rightProperty));
            #endregion
            ...
            if (OWLDLIntegrityChecks())
            {
                ...
                OWLSemanticsEvents.RaiseSemanticsWarning(string.Format("Inverse relation between property '{0}' and property '{1}' cannot be declared to the model because it would violate OWL-DL integrity", leftProperty, rightProperty));
        ...
        public OWLOntologyPropertyModel DeclarePropertyChainAxiom(RDFResource owlProperty, List<RDFResource> chainProperties)
        {
            ...
            if (chainProperties == null)
                throw new OWLSemanticsException("Cannot declare owl:propertyChainAxiom relation to the model because given \"chainProperties\" parameter is null");
            ...
            if (OWLDLIntegrityChecks())
            {
                ...
                //Handle automatic property declaration, if configured
                if (OWLSemanticsOptions.EnableAutomaticPropertyDeclaration)
                    chainProperties.ForEach(p => DeclareObjectProperty(p));
                ...
                OWLSemanticsEvents.RaiseSemanticsWarning(string.Format("PropertyChainAxiom '{0}' cannot be declared to the model because it would violate OWL-DL integrity", owlProperty));
    ...
    public class OWLOntologyObjectPropertyBehavior : OWLOntologyDatatypePropertyBehavior
    {
        ...
        internal bool Validate(RDFResource objectProperty)
        {
            if (Symmetric && Asymmetric)
                throw new OWLSemanticsException(string.Format($"Cannot have object property '{0}' at the same time symmetric and asymmetric!", objectProperty));
            if (Reflexive && Irreflexive)
                throw new OWLSemanticsException(string.Format($"Cannot have object property '{0}' at the same time reflexive and irreflexive!", objectProperty));
            return true;
        }
        #endregion
    }
