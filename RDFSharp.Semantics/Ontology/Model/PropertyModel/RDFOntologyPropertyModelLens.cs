...
{
    /// <summary>
    /// RDFOntologyPropertyModelLens represents a magnifying glass on the knowledge available for a given owl:Property instance within an ontology
    /// </summary>
    public class RDFOntologyPropertyModelLens
    {
        ...
        /// </summary>
        public RDFOntologyPropertyModelLens(RDFResource owlProperty, RDFOntology ontology)
        {
            if (owlProperty == null)
                throw new RDFSemanticsException("Cannot create property model lens because given \"owlProperty\" parameter is null");
            if (ontology == null)
        ...
        public List<RDFTriple> ObjectAnnotations()
        {
            ...
            result.AddRange(Ontology.Model.PropertyModel.TBoxGraph.Where(ann => ann.TripleFlavor == RDFModelEnums.RDFTripleFlavors.SPO
        ...
        public List<RDFTriple> DataAnnotations()
        {
            ...
            result.AddRange(Ontology.Model.PropertyModel.TBoxGraph.Where(ann => ann.TripleFlavor == RDFModelEnums.RDFTripleFlavors.SPL
                                                                                    && Ontology.Model.PropertyModel.CheckHasAnnotationProperty((RDFResource)ann.Predicate)
                                                                                        && ann.Subject.Equals(Property)));
