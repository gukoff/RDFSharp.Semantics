...
namespace RDFSharp.Semantics
{
    ...
    public class OWLOntologyPropertyModelLens
    {
        ...
        {
            if (owlProperty == null)
                throw new OWLSemanticsException("Cannot create property model lens because given \"owlProperty\" parameter is null");
            if (ontology == null)
                throw new OWLSemanticsException("Cannot create property model lens because given \"ontology\" parameter is null");
